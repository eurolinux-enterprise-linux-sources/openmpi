...
dnl 
dnl Generated by mpiteam at Thu Jan 21 13:12:32 2016
...
m4_define([mca_orte_state_no_config_component_list], [app, staged_orted, staged_hnp, tool, hnp, orted, novm, dvm])
...
m4_define([mca_ompi_common_m4_config_component_list], [verbs_usnic, ugni, sm, verbs, cuda])
...
m4_define([mca_ompi_mtl_m4_config_component_list], [psm, ofi, mxm, portals4, psm2])
...
m4_define([mca_ompi_osc_m4_config_component_list], [pt2pt, portals4])
m4_define([mca_ompi_osc_no_config_component_list], [sm])

dnl Components in the ompi / pml framework
m4_define([mca_ompi_pml_m4_config_component_list], [bfo, crcpw, v, yalla, ob1, ucx])
